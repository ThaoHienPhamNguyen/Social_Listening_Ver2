...
describe('getTopicDetail', () => {
  it('fetches the 7-day range ending on latestDate and filters engagement rows to the requested keyword', async () => {
    ...
    const result = await getTopicDetail(candidateReader, threadsReader, 'bitcoin', '2026-08-24');
